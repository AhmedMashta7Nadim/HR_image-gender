...
namespace HR.Migrations
{
    ...
    [Migration("20240821020041_ginder")]
    partial class ginder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HR_Models.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CityId = new Guid("685f4dec-1e5a-4881-817c-932cdd4caf67"),
                            Father = "Ismail",
                            Functional_ID = 0,
                            IsActive = true,
                            LastName = "Ismail",
                            ...
                            Name = "MohamedIsmail",
                            Salary_basis = 1m,
                            UniverCityId = new Guid("4b5aed57-60e4-4710-9855-a35970991117"),
                            UniversityDegree = 0,
                            date_of_employment = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            gendar = 0
                        });
                });
            ...
            modelBuilder.Entity("Token_HR.Model.AccessEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("accessEmployees");

                    b.HasData(
                        new
                        {
                            Id = new Guid("ec72e51d-8c19-41b0-9e64-fe8c636f65fc"),
                            IdEmployee = new Guid("5e44452c-4f92-4461-9acb-84c9251ea9cf"),
                            Role = "Admin"
                        });
                });
